...
// NewCmdDnsUpdatePTR returns new cobra command to update DNS PTR record
func NewCmdDnsUpdatePTR(in io.Reader, out, errout io.Writer) *cobra.Command {
	...
	cmd := &cobra.Command{
		Use:   "ptr domain id",
		Short: "update PTR record DNS for domain name (Example: example.com 1)",
		// TODO
		Long: heredoc.Doc(`
