...
// NewCmdDnsUpdateSRV returns new cobra command to update DNS SRV record
func NewCmdDnsUpdateSRV(in io.Reader, out, errout io.Writer) *cobra.Command {
	...
	cmd := &cobra.Command{
		Use:   "srv domain id",
		Short: "update SRV record #id for domain name (Example: example.com 1)",
		// TODO
		Long: heredoc.Doc(`
