...
// NewCmdDnsCreateSPF returns new cobra command to create DNS SPF record
func NewCmdDnsCreateSPF(in io.Reader, out, errout io.Writer) *cobra.Command {
	var textFlag string
	var nameFlag string
	var ttlFlag int
	var cloudFlag bool
	...
	cmd := &cobra.Command{
		Use:   "spf domain",
		Short: "create SPF record DNS for domain name (Example: example.com)",
		// TODO
		Long: heredoc.Doc(`
