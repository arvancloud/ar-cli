...
// NewCmdDnsCreateMX returns new cobra command to create DNS MX record
func NewCmdDnsCreateMX(in io.Reader, out, errout io.Writer) *cobra.Command {
	var hostFlag string
	...
	cmd := &cobra.Command{
		Use:   "mx domain",
		Short: "create MX record DNS for domain name (Example: example.com)",
		// TODO
		Long: heredoc.Doc(`
