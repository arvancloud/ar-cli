...
// NewCmdDnsCreateAAAA returns new cobra command to create DNS AAAA record
func NewCmdDnsCreateAAAA(in io.Reader, out, errout io.Writer) *cobra.Command {
	var ipFlag string
	var portFlag int
	var weightFlag int
	...
	cmd := &cobra.Command{
		Use:   "aaaa domain",
		Short: "create AAAA record DNS for domain name (Example: example.com)",
		// TODO
		Long: heredoc.Doc(`
